...
export declare class CreditRepaymentController {
    private readonly creditRepaymentService;
    constructor(creditRepaymentService: CreditRepaymentService);
    ...
    update(id: string, updateCreditRepaymentDto: UpdateCreditRepaymentDto): Promise<{
        branch: {
            name: string;
            type: import(".prisma/client").$Enums.BranchType;
            phoneNumber: string | null;
